    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleSubSystemAccesses", x => new { x.RoleId, x.SubSystemId });
                    table.ForeignKey(
                        name: "FK_RoleSubSystemAccesses_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleSubSystemAccesses_SubSystems_SubSystemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDivisionAssignments", x => new { x.UserId, x.DivisionId });
                    table.ForeignKey(
                        name: "FK_UserDivisionAssignments_Divisions_DivisionId",
                        column: x => x.DivisionId,
                        principalTable: "Divisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDivisionAssignments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSubSystemAccesses", x => new { x.UserId, x.SubSystemId });
                    table.ForeignKey(
                        name: "FK_UserSubSystemAccesses_SubSystems_SubSystemId",
                        column: x => x.SubSystemId,
                        principalTable: "SubSystems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSubSystemAccesses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleSubSystemAccesses_SubSystemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDivisionAssignments_DivisionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubSystemAccesses_SubSystemId",
