...
- [ ] **4. Wire the API layer and get login working**
...
- [ ] **5. Build out the remaining backend features** (in this order — each depends on the last)
  - [ ] 5a. Users / Roles / RolePermissions (core RBAC)
  - [ ] 5b. Divisions / Sections (`DivisionScopeBehavior` depends on these existing)
